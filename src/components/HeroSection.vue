    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="680"
      ...
      <g transform="translate(960,440) scale(1,1) translate(-960,-440)">
        <linearGradient id="lg-0.047955344060927496" x1="0" x2="1" y1="0" y2="0">
          <stop stop-color="#DC143C" offset="0"></stop>
          <stop stop-color="#FF0146" offset="1"></stop>
        </linearGradient>
  ...
  <div class="w-100 mx-auto px-6 sm:max-w-2xl md:max-w-3xl md:px-12 lg:max-w-5xl xl:max-w-7xl xl:px-32">
    <div class="text-center m-8">
      <div
          ...
          ">
        <h2 style="padding-bottom: 2rem" class="mt-6 mb-16 text-3xl text-[#b32d49] font-extralight shadow-pink-50 tracking-tight md:text-4xl xl:text-5xl">
          Адзіны ў свеце JavaScript курс на роднай мове. <br /><span class="text-primary">Заўсёды безкаштоўны, для беларусаў і па-беларуску.</span>
        </h2>


      </div>
    </div>
    <div style="height: 2rem" class="h-10"></div>
  </div>
